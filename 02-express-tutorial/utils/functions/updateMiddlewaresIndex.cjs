...
// Specify the directory where your modules are located
const moduleDirectory = './middlewares';

// Function to generate the index.js file
const generateIndexFile = () => {
  // Read the module files from the directory
  fs.readdir(moduleDirectory, (err, files) => {
    ...
    fs.writeFile(path.join(moduleDirectory, 'index.js'), indexContent, err => {
      ...
      console.log('index.js file updated successfully!');
    });
  });
};
...
// Generate the initial index.js file
generateIndexFile();
